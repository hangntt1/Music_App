package hcmute.edu.vn.duan_gk.extras;
...
public class Utils {
    ...
    private static final String ACCENT_PREF = "hcmute.edu.vn.duan_gk.pref_accent";
    private static final String ACCENT_VALUE = "hcmute.edu.vn.duan_gk.pref_accent_value";
    private static final String THEME_PREF = "hcmute.edu.vn.duan_gk.pref_theme";
    private static final String THEME_VALUE = "hcmute.edu.vn.duan_gk.pref_theme_value";
    private static final String SEARCH_BAR_PREF = "hcmute.edu.vn.duan_gk.pref_search_bar";
    private static final String SEARCH_BAR_VALUE = "hcmute.edu.vn.duan_gk.pref_search_bar_value";
