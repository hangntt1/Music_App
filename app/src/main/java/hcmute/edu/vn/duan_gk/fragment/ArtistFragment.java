...
import hcmute.edu.vn.duan_gk.adapters.ArtistAdapter;
...
public class ArtistFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = requireActivity().findViewById(R.id.recyclerView_Artist);
    ...
    public void onResume() {
        ...
        ((MainActivity) requireActivity()).setActionBarTitle("Artists");
