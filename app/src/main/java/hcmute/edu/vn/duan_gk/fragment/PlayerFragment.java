...
public class PlayerFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        NowPlayingTrack = requireActivity().findViewById(R.id.song);
    ...
    public void onResume() {
        ...
        ((MainActivity) requireActivity()).setActionBarTitle("Player");
    ...
    private void playSongWithoutService(long currSong){
        ...
        mediaPlayer.setWakeMode(requireActivity().getApplicationContext(), PowerManager.PARTIAL_WAKE_LOCK);
